        ...
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg max-w-md w-full p-6`}>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-orange-500 text-white px-6 py-2 rounded-lg hover:bg-orange-600 font-bold"
            >
              Subscribe
            </button>
          </div>
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full border-2 border-orange-500 text-orange-500 py-2 rounded-lg hover:bg-orange-50 font-semibold"
            >
              Clear All Filters
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <form onSubmit={completeOrder} className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg p-6`}>
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-500 hover:bg-orange-600 text-white py-4 rounded-lg font-bold text-lg transition"
                >
                  Place Order
                </button>
              </form>
      ...
      <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50'} flex items-center justify-center p-4`}>
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg shadow-lg p-8 max-w-md w-full text-center`}>
          ...
          <div className="flex gap-3">
            <button
              onClick={() => setCurrentView('home')}
              className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-lg font-bold transition"
            >
              Continue Shopping
            </button>
            <button
