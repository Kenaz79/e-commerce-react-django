      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm dark:shadow-gray-900 min-h-[600px]">
          <div className="p-6">
            ...
            {adminTab === 'deliverers' && (
  <DeliverersManagement 
    loading={loading}
    deliverers={deliverers}
    showAddDeliverer={showAddDeliverer}
    setShowAddDeliverer={setShowAddDeliverer}
    newDeliverer={newDeliverer}
    setNewDeliverer={setNewDeliverer}
    handleAddDeliverer={handleAddDeliverer}
    toggleDelivererOnline={toggleDelivererOnline}
